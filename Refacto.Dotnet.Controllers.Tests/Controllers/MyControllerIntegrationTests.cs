    ...
    public class MyControllerIntegrationTests : IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        private static List<Product> CreateProducts()
        {
            return new List<Product>
            {
                ...
                new Product { LeadTime = 15, Available = 20, Type = "FLASHSALE", Name = "Watermelon", SeasonStartDate = DateTime.Now.AddDays(-2), SeasonEndDate = DateTime.Now.AddDays(58) },
                new Product { LeadTime = 15, Available = 20, Type = "FLASHSALE", Name = "Grapes", SeasonStartDate = DateTime.Now.AddDays(180), SeasonEndDate = DateTime.Now.AddDays(240) }
